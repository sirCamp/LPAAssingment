...
L'eccezione lanciata da throw x in M viene raccolta dal primo catch (quello piu' vicino).
...
La regola SELECT va bene cosi' e basta per tirare fuori i lanci di eccezione che comunque vengono valutati in seguito tramite altre regole.
