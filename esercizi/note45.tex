...
Se $M$ \`e un termine ben tipato vuol dire che il giudizio di tipo $\Gamma$ $\vdash$ $M$ : $T$ \`e derivabile con un albero di derivazione di altezza $h+1$ e quindi l'induzione viene fatta su $h+1$.
